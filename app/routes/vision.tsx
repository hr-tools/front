...
// @ts-ignore
import { foalLayerUrlRegex } from '~/common/regexes'
// @ts-ignore
          ...
          <div className='rounded bg-gray-200 dark:bg-slate-800 p-5 mt-5'>
            <Form
              onSubmit={async (e) => {
                ...
                if (data.error) {
                  ...
                  data.horse.raw_breed = payload.horse_info.breed
                  data.horse.raw_layer_urls = payload.layer_urls
                  setBanner(null)
                  setResults(data)
            ...
            >
              ...
              {inputKeys.map((key, index) => {
                return (
                  <div className='flex' key={`draft-layer-url-${key}`}>
                    <TextInput
                      placeholder='https://horsereality.com/upload/.../foals/...'
              ...
              <div className='space-x-2'>
                ...
                <Button styletype='secondary' onClick={toggleOptions}>Options <i id='options-icon' className='ci-chevron_up'/></Button>
    ...
    >
      ...
      <div className='space-x-2'>
        ...
        <Button onClick={() => {
          ...
          data.horse.raw_layer_urls.forEach((layerUrl: string) => {url.searchParams.append('layer', layerUrl.replace('https://www.horsereality.com/upload/', '').replace('.png', ''))})
